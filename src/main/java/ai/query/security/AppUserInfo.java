 ...
 * management implementation ({@link ai.query.security.AppUserInfo},
 * {@link ai.query.security.CurrentUser})</li>
 * <li>A value object for identifying users ({@link ai.query.security.domain.UserId})</li>
 * <li>Method-level security and JPA auditing ({@link ai.query.security.CommonSecurityConfig})</li>
 ...
 * </p>
 */
package ai.query.security;

import ai.query.security.domain.UserId;
